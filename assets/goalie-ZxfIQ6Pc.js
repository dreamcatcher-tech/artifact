const e={description:"Figures out what goal the user wants to do and returns the path to a help file that can be executed to achieve the goal.",config:{model:"gpt-4-1106-preview",temperature:.8},runner:"runner-chat",commands:["helps/help-finder","engage-help:load","engage-help:engage"],instructions:[`
